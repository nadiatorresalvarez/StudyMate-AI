...
internal class GenerateBriefSummaryCommandHandler : IRequestHandler<GenerateBriefSummaryCommand, GenerateBriefSummaryResponseDto>
{
    private readonly IDocumentRepository _documentRepository;
    private readonly IRepository<Summary> _summaryRepository;
    private readonly IGeminiService _geminiService;

    public GenerateBriefSummaryCommandHandler(
    ...
    public async Task<GenerateBriefSummaryResponseDto> Handle(GenerateBriefSummaryCommand request, CancellationToken cancellationToken)
    {
        ...
        // Llamar a Gemini para generar resumen breve
        var summaryText = await _geminiService.GenerateBriefSummaryAsync(document.ExtractedText!, cancellationToken);
